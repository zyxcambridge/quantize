...
dnl
dnl Generated by ec2-user at Tue Mar 26 18:11:00 2019
dnl on ip-172-31-10-147.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_orte_framework_list], [common, dfs, errmgr, ess, filem, grpcomm, iof, notifier, odls, oob, plm, ras, regx, rmaps, rml, routed, rtc, schizo, snapc, sstore, state])
...
m4_define([mca_orte_notifier_m4_config_component_list], [syslog])
m4_define([mca_orte_notifier_no_config_component_list], [])
...
m4_define([mca_orte_regx_no_config_component_list], [fwd, reverse])
