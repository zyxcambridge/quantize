...
#define HAVE___MALLOC_INITIALIZE_HOOK 1
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc -std=gnu99 -std=gnu99' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/mca/event/libevent2022/libevent -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/mca/event/libevent2022/libevent/include -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/mca/hwloc/hwloc201/hwloc/include  ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OPAL_PACKAGE_STRING "Open MPI root@bogon Distribution"
...
#define WRAPPER_EXTRA_LIBS "-lm -ldl -lutil  -lrt -lz"
