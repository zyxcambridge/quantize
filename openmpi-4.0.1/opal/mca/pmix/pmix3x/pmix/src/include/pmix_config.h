...
#define PMIX_ASSEMBLY_BUILTIN PMIX_BUILTIN_NO
...
#define PMIX_CONFIGURE_CLI " \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-debug\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/libevent2022/libevent2022.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/hwloc201/hwloc201.h\"' \'--prefix=/usr/local\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1 -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1 -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/include -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/include -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/mca/event/libevent2022/libevent -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/mca/event/libevent2022/libevent/include -I/data1/zyx/frcn/PocketFlow/openmpi-4.0.1/opal/mca/hwloc/hwloc201/hwloc/include  \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Sun Jul 14 17:12:53 CST 2019"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "bogon"
...
#define PMIX_PACKAGE_STRING "PMIx root@bogon Distribution"
